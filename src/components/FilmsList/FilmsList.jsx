      ...
      {filteredFilms.map((film) => (
        <div
          ...
          <img
            ...
            className="film-logo h-96 w-80 rounded-t-lg mx-auto object-cover md:h-auto md:w-36 md:!rounded-none md:!rounded-s-lg"
            src={film.image}
            alt={film.title}
          />
          <div className="film-about flex flex-col justify-start p-6" onClick={() => { handleFilmClick(film.id) }} style={{ width: '100%' }}>
          ...
          <div className="film-buttons text-xs text-surface/75 dark:text-neutral-300 last">{''}
